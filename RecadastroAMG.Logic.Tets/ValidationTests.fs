...
type ValidationTests (outputhelper:ITestOutputHelper) =
    ...
    let ``String60 é corretamente validada e invalidada`` () =
        ...
        let contato:Contato =
            {
                Telefone1=  (Telefone.Create "619999444376") |> function |Ok x -> x |_ -> "";
                Telefone2= None;
                Email = Email.Create "jesse@quatrodconsultoria.com.br" |> function |Ok x -> x |_ -> ""
        ...
        ``Adicioanr Registro ao contexto`` registro
        ()
